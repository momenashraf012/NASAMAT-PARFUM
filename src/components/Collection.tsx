...
export function Collection() {
  ...
  const hasActiveFilters = searchQuery || selectedFamily !== 'all' || sortBy !== 'newest' || minPrice > 0 || maxPrice < 2000 || minRating > 0
      ...
      <div className="wrap">
        ...
        <div className="mb-8 space-y-4">
          ...
          <div className="relative">
            <Search size={18} className="absolute right-4 top-1/2 -translate-y-1/2 text-grey-3 pointer-events-none" />
            <input
              type="text"
