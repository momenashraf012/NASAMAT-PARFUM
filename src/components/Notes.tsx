...
function NoteItem({ glyph, ar, en, desc, idx }: NoteItemProps) {
  ...
  return (
    ...
    >
      ...
      <h3 className="font-ar-display font-bold text-2xl text-ivory mt-6">
        {ar}
      </h3>
      ...
      <p className="font-ar-body text-xs md:text-sm leading-relaxed text-grey-3 mt-4">
        {desc}
      </p>
    </div>
  )
      ...
      <div className="wrap relative">
        ...
        >
          ...
          <h2 className="font-ar-display font-bold text-3xl md:text-4xl lg:text-5xl text-ivory mt-4 leading-tight">
            المكوّنات التي تصنع الأثر
          </h2>
          <p className="font-ar-body text-base md:text-lg text-grey-3 leading-loose mt-6">
            أربعة أركان عربية أصيلة تتكرّر في كل تركيبة من نَسَمَات — كلٌّ منها يحمل طابعه
            وذاكرته.
          </p>
        </div>
